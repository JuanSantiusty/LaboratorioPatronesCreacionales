...
/**
 * @brief Conferencia de tipo Workshop que implementa la interfaz InterfazConferencia, tiene título y una lista de sesiones
 * y una lista de participantes
 * */

public class Workshop implements InterfazConferencia{

    private String titulo;
    private List<Participante> participantes;
    private List<Sesion> secciones;

    public Workshop(String titulo) {
        this.titulo = titulo;
