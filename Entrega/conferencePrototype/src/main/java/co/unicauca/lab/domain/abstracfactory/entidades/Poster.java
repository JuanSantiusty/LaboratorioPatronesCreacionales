...
/**
 * @brief Conferencia de tipo Poster que implementa la interfaz InterfazConferencia, tiene título y una lista de sesiones
 * y una lista de participantes
 * */

public class Poster implements InterfazConferencia{
